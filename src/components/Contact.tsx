    ...
    <section id="contact" className="py-20 px-4 bg-bg-dark">
      <div className="container mx-auto max-w-2xl text-center">
        ...
        <p className="text-text-muted mb-8">
          Открыт для новых проектов и интересных предложений. Буду рад обсудить,
          как я могу быть полезен вашему бизнесу.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <a
            href="mailto:revengernick079@gmail.com"
            className="group flex items-center justify-center gap-3 bg-bg-light p-4 rounded-lg text-text-main transition-all duration-300 hover:bg-primary hover:text-bg-dark hover:shadow-lg hover:shadow-primary/30"
          >
