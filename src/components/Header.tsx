  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        hasScrolled
          ? "bg-bg-dark/80 backdrop-blur-lg shadow-lg"
          : "bg-transparent"
      }`}
    >
      ...
      <div
        className={`fixed inset-0 bg-bg-dark/90 backdrop-blur-lg flex flex-col items-center justify-center gap-8 transition-opacity duration-300 md:hidden ${
